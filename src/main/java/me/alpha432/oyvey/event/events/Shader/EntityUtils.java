...
public class EntityUtils implements IMinecraft
{
    ...
    public static boolean isntValid(final Entity entity) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtils.mc.player) || (entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName()));
    }
