package me.alpha432.oyvey.event.events.Shader;
...
public abstract class Shader {
    ...
    public Shader(String fragmentShader) {
        ...
        int vertexShaderID;
        try {
            InputStream vertexStream = this.getClass().getResourceAsStream("/assets/equinox/shader/vertex.vert");
            ...
            InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/equinox/shader/" + fragmentShader);
