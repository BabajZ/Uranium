...
public class CrystalAura
    ...
    private final Setting<Integer> alpha = this.register(new Setting<Integer>("Alpha", 253, 0, 255));
    private final Setting<Integer> boxAlpha = this.register(new Setting<Integer>("BoxAlpha", 125, 0, 255));
    private final Setting<Float> lineWidth = this.register(new Setting<Float>("LineWidth", Float.valueOf(10.0f), Float.valueOf(1.0f), Float.valueOf(10.0f)));
    public Setting<Boolean> place = this.register(new Setting<Boolean>("Place", true));
    public Setting<Float> placeDelay = this.register(new Setting<Float>("PlaceDelay", Float.valueOf(100.0f), Float.valueOf(0.0f), Float.valueOf(300.0f)));
    ...
    public Setting<Boolean> predicts = this.register(new Setting<Boolean>("Predict", false));
    public Setting<Boolean> rotate = this.register(new Setting<Boolean>("Rotate", true));
    public Setting<Float> breakDelay = this.register(new Setting<Float>("BreakDelay", Float.valueOf(100.0f), Float.valueOf(0.0f), Float.valueOf(300.0f)));
    ...
    public Setting<Boolean> opPlace = this.register(new Setting<Boolean>("1.13 Place", false));
    ...
    public Setting<Float> facePlace = this.register(new Setting<Float>("FacePlaceHP", Float.valueOf(15.0f), Float.valueOf(0.0f), Float.valueOf(36.0f)));
    ...
    private final Setting<Integer> cRed = this.register(new Setting<Object>("OL-Red", Integer.valueOf(3), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    private final Setting<Integer> cGreen = this.register(new Setting<Object>("OL-Green", Integer.valueOf(219), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    private final Setting<Integer> cBlue = this.register(new Setting<Object>("OL-Blue", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    ...
    public void onCrystal() {
        ...
        if (this.placeTimer.passedMs(this.placeDelay.getValue().longValue()) && this.place.getValue().booleanValue()) {
            ...
            if (this.hotBarSlot != -1 && this.autoswitch.getValue().booleanValue() && !CrystalAura.mc.player.isPotionActive(MobEffects.WEAKNESS)) {
