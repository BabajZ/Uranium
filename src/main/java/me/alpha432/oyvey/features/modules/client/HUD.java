...
public class HUD extends Module {
    ...
    public Setting<String> command = register(new Setting("Command", "Uranium"));
    public Setting<TextUtil.Color> bracketColor = register(new Setting("BracketColor", TextUtil.Color.DARK_GREEN));
    public Setting<TextUtil.Color> commandColor = register(new Setting("NameColor", TextUtil.Color.GREEN));
