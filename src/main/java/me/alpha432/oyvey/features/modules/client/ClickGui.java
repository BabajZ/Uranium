...
public class ClickGui
    ...
    public Setting<Integer> hoverAlpha = this.register(new Setting<Integer>("Alpha", 120, 0, 255));
    public Setting<Integer> topRed = this.register(new Setting<Integer>("SecondRed", 0, 0, 255));
    public Setting<Integer> topGreen = this.register(new Setting<Integer>("SecondGreen", 157, 0, 255));
    public Setting<Integer> topBlue = this.register(new Setting<Integer>("SecondBlue", 43, 0, 255));
    public Setting<Integer> alpha = this.register(new Setting<Integer>("HoverAlpha", 191, 0, 255));
    ...
    public ClickGui() {
        ...
        this.setInstance();
        this.bind.setValue(new Bind(Keyboard.KEY_P));
    }
