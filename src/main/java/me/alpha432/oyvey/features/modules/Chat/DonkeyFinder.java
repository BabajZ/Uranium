...
class DonkeyFinder
    ...
    public DonkeyFinder( ) {
        super ( "+ DonkeyFinder" , "for wakespace" , Category.CHAT , true , false , false );
    }
    ...
    public void onUpdate ( ) {
        for (Entity entity : DonkeyFinder.mc.world.getLoadedEntityList ( )) {
            ...
            if ( this.Chat.getValue ( ) ) {
                Command.sendMessage (TextUtil.GREEN + "Yo! I found a donkey near: " + entity.getPosition ( ).getX ( ) + "x, " + entity.getPosition ( ).getY ( ) + "y, " + entity.getPosition ( ).getZ ( ) + "z." );
            }
