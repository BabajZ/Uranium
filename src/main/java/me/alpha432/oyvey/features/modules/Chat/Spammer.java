...
public class Spammer
        extends Module {
    private static final String fileName = "oyvey/Spammer.txt";
    ...
    public Setting<Integer> delay = this.register(new Setting<Object>("DelayS", Integer.valueOf(10), Integer.valueOf(1), Integer.valueOf(20), v -> this.delayType.getValue() == DelayType.S));
    ...
    public Spammer() {
        super("Spammer", "Spams stuff.", Category.CHAT, true, false, false);
    }
    ...
    public void onUpdate() {
        ...
        if (this.mode.getValue() == Mode.PWORD) {
            String msg = "https://discord.gg/cFdhduVCC2 -- dazed68 owns you";
