...
class AutoBuilder
    ...
    private final Setting < Integer > bRed = this.register ( new Setting <> ( "BoxRed" , 0 , 0 , 255 , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.box.getValue ( ) ) );
    private final Setting < Integer > bGreen = this.register ( new Setting <> ( "BoxGreen" , 255 , 0 , 255 , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.box.getValue ( ) ) );
    private final Setting < Integer > bBlue = this.register ( new Setting <> ( "BoxBlue" , 0 , 0 , 255 , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.box.getValue ( ) ) );
    ...
    private final Setting < Integer > oRed = this.register ( new Setting <> ( "OutlineRed" , 0 , 0 , 255 , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.outline.getValue ( ) ) );
    ...
    private final Setting < Integer > oBlue = this.register ( new Setting <> ( "OutlineBlue" , 0 , 0 , 255 , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.outline.getValue ( ) ) );
    ...
    private final Setting < Float > lineWidth = this.register ( new Setting <> ( "LineWidth" , 5.0f , 0.1f , 5.0f , v -> this.settings.getValue ( ) == Settings.RENDER && this.render.getValue ( ) && this.outline.getValue ( ) ) );
    // MISC
