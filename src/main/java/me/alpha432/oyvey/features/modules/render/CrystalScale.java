...
public class CrystalScale
    ...
    public CrystalScale() {
        super("CrystalCham", "Modifies crystal rendering in different ways", Module.Category.RENDER, true, false, false);
        INSTANCE = this;
    }
    ...
    @SubscribeEvent
    public void onReceivePacket(PacketEventShit.Receive event) {
