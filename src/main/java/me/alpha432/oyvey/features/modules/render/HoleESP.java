...
public class HoleESP
    ...
    private final Setting<Integer> range = this.register(new Setting<Integer>("RangeX", 10, 0, 10));
    private final Setting<Integer> rangeY = this.register(new Setting<Integer>("RangeY", 10, 0, 10));
