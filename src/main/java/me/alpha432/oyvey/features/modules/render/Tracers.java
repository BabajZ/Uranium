...
public class Tracers extends Module {
    ...
    Setting<Double> width = this.register(new Setting<Double>("Width", 2.0, 0.0, 10.0));
    Setting<Double> range = this.register(new Setting<Double>("Range", 100.0, 0.0, 500.0));
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        mc.world.loadedEntityList.forEach(entity -> {
            ...
            if (!friends.getValue() && OyVey.friendManager.isFriend(player.getName())) return;
