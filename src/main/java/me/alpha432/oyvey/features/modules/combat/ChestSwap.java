...
public class ChestSwap extends Module
{
    ...
    public ChestSwap()
    {
        super("ChestSwap","Will attempt to instantly swap your chestplate with an elytra or vice versa, depending on what is already equipped", Category.PLAYER, true, false, false);
    }
