...
public class LogoutSpots
    ...
    public LogoutSpots() {
        super("LogoutSpot", "Renders LogoutSpots", Module.Category.RENDER, true, false, false);
    }
    ...
    public void onConnection(ConnectionEvent event) {
        if (event.getStage() == 0) {
            ...
            if (entity != null && this.message.getValue().booleanValue()) {
                Command.sendMessage("\u00a7a" + entity.getName() + " just logged in" + (this.coords.getValue() != false ? " at (" + (int) entity.posX + ", " + (int) entity.posY + ", " + (int) entity.posZ + ")!" : "!"));
            }
            ...
            if (this.message.getValue().booleanValue()) {
                Command.sendMessage("\u00a7c" + event.getName() + " just logged out" + (this.coords.getValue() != false ? " at (" + (int) entity.posX + ", " + (int) entity.posY + ", " + (int) entity.posZ + ")!" : "!"));
            }
