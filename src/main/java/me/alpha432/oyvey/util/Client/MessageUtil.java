...
public class MessageUtil {
    public static final String messagePrefix = ChatFormatting.GREEN + "[" + "Uranium" + ChatFormatting.GREEN + "] " + ChatFormatting.RESET;
    public static final String errorPrefix = ChatFormatting.GREEN + "[" + "Uranium" + "] " + ChatFormatting.RESET;
